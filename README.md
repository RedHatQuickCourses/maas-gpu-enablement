...
This repository was originally created for the "Nvidia Accelerator Configuration for Scale" GPU enablement course. As of **2026-05-04**, it was migrated to contain the "Red Hat OpenShift AI - Models as a Service" course content to make it publicly available for community contributions.

The previous GPU enablement content is archived in:
- **Archive directory**: `old/gpu-enablement-2026-05-04/`
- **Git branch**: `backup-gpu-content-2026-05-04`

The original GPU course covered:
